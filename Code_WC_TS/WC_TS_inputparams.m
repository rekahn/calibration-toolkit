function [TS,f]=WC_TS_inputparams(D, S, T, depth, lat, plot_flag);
% D = WC sphere diameter in mm
% S = salininty, T = temperature, depth in m, lat = latitute
...
cw = sw_svel(S,T,sw_pres(depth,lat));
g=14900./1000;% Density of Sphere 14900
...
f=cw.*outx./2./pi./R';
%TS=10.*log10(outy./2.*R.^2)'; % THIS COULD BE WRONG; should be outy.^2
