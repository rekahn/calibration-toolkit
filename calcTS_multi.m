...
% % DEMER FORMULATION
zer = str2double(cal.config.Impedance); %/2 from Demer report which cites values of 5.4 kOhms
zet = cal.Z;
...
if plot_flag == 1 && ~isempty(TS_data)
    ...
    plot(f_model/1000,TS_model,'r','LineWidth',2);
